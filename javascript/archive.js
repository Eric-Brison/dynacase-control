...
//						},
	                    ...
	                    refresh: function(){
	                        ...
	                        var contextInfoHtml = '<ul><li class="x-form-item"><b>Archive Datetime :</b> ' + Ext.util.Format.htmlEncode(this.archive.datetime) + '</li><li class="x-form-item"><b>Description :</b> ' + Ext.util.Format.htmlEncode(this.archive.description) + '</li><li class="x-form-item"><b>Archive id :</b> ' + Ext.util.Format.htmlEncode (this.archive.id) + '<li></ul><p>';
